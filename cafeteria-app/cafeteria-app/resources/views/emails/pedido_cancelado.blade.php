...
<head>
    <style>
        ...
        h2 { font-family: 'DM Serif Display', serif; color: #E05C5C; margin-top: 0; }
...
<body>
    <div class="container">
        ...
        <p>Hola,</p>
        <p>Lamentamos informarte que tu pedido en <strong>SGPD</strong> ha sido cancelado.</p>
        
        <div class="details">
            <p><strong>Referencia del Pedido:</strong> #{{ $pedido->id }}</p>
            <p><strong>Total:</strong> ${{ number_format($pedido->total, 0, ',', '.') }}</p>
            <p><strong>Estado:</strong> <span class="badge">Cancelado</span></p>
            <p><strong>Fecha/Hora:</strong> {{ now()->format('d/m/Y g:i A') }}</p>
        </div>

        <p>Si tienes alguna duda o consideras que esto es un error, por favor ponte en contacto con nuestro equipo de soporte.</p>
