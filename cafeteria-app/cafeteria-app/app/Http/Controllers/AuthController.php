...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // ✅ Ignorar el TenantScope aquí, porque al no estar autenticado,
        // el scope ejecutaría `1=0` y nunca encontraría al usuario ni a su rol.
        $usuario = Usuario::withoutGlobalScope(\App\Scopes\TenantScope::class)
    ...
    public function logout(Request $request)
    {
        ...
        if ($token) {
            Sesion::withoutGlobalScope(\App\Scopes\TenantScope::class)
                ->where('token', $token)->update(['activa' => false]);
        }
