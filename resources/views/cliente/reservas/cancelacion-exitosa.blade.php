...
<head>
    ...
    <title>Reserva Cancelada — {{ $reserva->codigo_reserva }}</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .icon{font-size:3.5rem;margin-bottom:1.5rem;display:block;color:#ef4444}
...
<div class="card">
    ...
    <h1 class="card-title">Reserva Cancelada</h1>
    <p class="card-desc">La reserva <strong>{{ $reserva->codigo_reserva }}</strong> ha sido cancelada exitosamente. Te hemos enviado un correo de confirmación. Esperamos verte en el futuro.</p>
