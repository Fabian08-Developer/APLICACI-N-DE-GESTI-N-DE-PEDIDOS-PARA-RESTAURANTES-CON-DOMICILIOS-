<div class="space-y-6">
    ...
    @if($showRejectModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#2C241B]/80 backdrop-blur-sm animate-in fade-in duration-300">
            <div class="bg-white border border-rose-500/30 p-8 rounded-[32px] max-w-md w-full shadow-2xl shadow-rose-900/20 relative overflow-hidden">
                ...
                <form wire:submit.prevent="rejectNitUpdate" class="space-y-4">
                    ...
                    <div class="flex gap-4 pt-2">
                        <button type="button" wire:click="closeRejectModal" class="flex-1 py-4 text-[#8B8175] font-black text-[10px] uppercase tracking-widest hover:text-[#2C241B] hover:bg-[#E6E2DB] rounded-2xl transition-all">
                            Cancelar
                        </button>
