...
<div class="grid-dos">
    ...
    <div class="tarjeta">
        ...
        <div style="padding: 0 1.5rem 2rem;">
            @if($totalMesas > 0)
                @php $porcentaje = round(($mesasOcupadas / $totalMesas) * 100); @endphp
                <div style="display: flex; justify-content: space-between; font-size: 0.75rem; color: var(--text-muted); margin-bottom: 0.6rem;">
                    ...
                    <span style="font-weight: 600; color: var(--text-main);">{{ $porcentaje }}%</span>
                </div>
                <div class="progreso-vacia">
                    <div class="progreso-llena" style="width: {{ $porcentaje }}%;"></div>
                </div>
            @else
