...
<div class="wrapper">
    ...
    <div class="cuerpo">
        ...
        <table>
            <tr><td>Pedido</td>            <td>#{{ $pedido->id }}</td></tr>
            <tr><td>Referencia de pago</td><td>{{ $pago->referencia_transaccion ?? 'N/A' }}</td></tr>
            <tr><td>Fecha de reembolso</td><td>{{ $pago->fecha_reembolso?->format('d/m/Y H:i') }}</td></tr>
        </table>
