...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>¡Hemos recibido tu solicitud de reserva!</h1>
            <p>{{ $reserva->sucursal->nombre ?? 'Nuestro restaurante' }}</p>
        </div>
        <div class="body">
            <p class="greeting">Hola, <strong>{{ $reserva->nombre_cliente }}</strong>.</p>
            <p style="color:#555; font-size:0.95rem; line-height:1.6;">Hemos recibido los datos de tu reserva exitosamente. Te adjuntamos a continuación el código de tu reserva.</p>

            @if($reserva->monto_deposito > 0 && !$reserva->deposito_pagado)
                <p style="color:#D97706; font-size:0.95rem; font-weight:600; line-height:1.6;">Atención: Tu reserva requiere el pago de un depósito de garantía de ${{ number_format($reserva->monto_deposito, 0, ',', '.') }} para ser confirmada. Por favor realiza el pago usando el enlace o en la sucursal.</p>
            @endif
            ...
            <div class="details">
                <div class="details-title">Detalles de tu solicitud</div>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><span class="badge-pending">{{ $reserva->estado->etiqueta() }}</span></span>
                </div>
            </div>

            <div class="cancel-btn">
                <a href="{{ url('/reserva/' . $reserva->codigo_reserva) }}" class="cancel-link" style="font-weight:bold; color:#C48B57; border:none;">
                    Consultar el estado de mi reserva
                </a>
            </div>
