...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #2C2621 0%, #4a3728 100%); padding: 36px 36px 28px; text-align: center; }
        .header-icon { font-size: 2.5rem; margin-bottom: 12px; display: block; }
        .header h1 { font-family: 'DM Serif Display', Georgia, serif; color: #F9F7F3; margin: 0; font-size: 1.6rem; font-weight: 400; }
        .header p { color: #C48B57; margin: 6px 0 0; font-size: 0.9rem; }
        .body { padding: 36px; }
        .greeting { font-size: 1rem; color: #2C2621; margin: 0 0 20px; }
        .code-box { background: linear-gradient(135deg, #FFF8F0, #FFF3E5); border: 2px solid #C48B57; border-radius: 12px; padding: 20px; text-align: center; margin: 24px 0; }
        .code-label { font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; color: #888; font-weight: 600; margin-bottom: 8px; display: block; }
        .code-value { font-family: 'Courier New', monospace; font-size: 1.8rem; font-weight: 700; color: #2C2621; letter-spacing: 0.12em; }
        .details { background: #FAFAF8; border: 1px solid #EDE9E4; border-radius: 12px; padding: 24px; margin: 24px 0; }
        .details-title { font-weight: 700; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.08em; color: #C48B57; margin: 0 0 16px; }
        .detail-row { display: flex; justify-content: space-between; align-items: flex-start; padding: 8px 0; border-bottom: 1px solid #EDE9E4; font-size: 0.9rem; }
        .detail-row:last-child { border-bottom: none; }
        .detail-label { color: #888; font-weight: 500; }
        .detail-value { color: #2C2621; font-weight: 600; text-align: right; }
        .badge-confirm { display: inline-block; background: #DEF7EC; color: #03543F; border-radius: 6px; padding: 4px 12px; font-size: 0.8rem; font-weight: 700; }
        .cancel-btn { display: block; text-align: center; margin: 28px 0 8px; }
        .cancel-link { color: #888; font-size: 0.82rem; text-decoration: none; border-bottom: 1px solid #ccc; padding-bottom: 1px; }
        .note { background: #FFF8F0; border-left: 3px solid #C48B57; border-radius: 0 8px 8px 0; padding: 14px 18px; font-size: 0.85rem; color: #6B5344; margin: 20px 0; }
        ...
        <div class="body">
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">Mesa #{{ $reserva->mesa->numero }} (cap. {{ $reserva->mesa->capacidad }})</span>
                </div>
                @endif
                <div class="detail-row">
