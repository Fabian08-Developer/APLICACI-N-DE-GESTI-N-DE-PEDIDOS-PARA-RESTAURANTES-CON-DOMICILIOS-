...
window.initConfirmacion = function(config) {
    ...
    const ESTADOS = {
        ...
        'EN_COCINA':      { orden: 1, barra: 25,  texto: 'Pedido recibido en cocina...' },
        'EN_PREPARACION': { orden: 2, barra: 55,  texto: 'Preparando tu pedido...' },
        'LISTO':          { orden: 3, barra: 85,  texto: '¡Tu pedido está listo!' },
        'ENTREGADO':      { orden: 4, barra: 100, texto: '¡Pedido entregado! ' },
        'CANCELADO':      { orden: -1, barra: 0,  texto: 'Pedido cancelado.' },
    };

    const ORDEN_PASOS = ['CREADO', 'EN_COCINA', 'EN_PREPARACION', 'LISTO', 'ENTREGADO'];
