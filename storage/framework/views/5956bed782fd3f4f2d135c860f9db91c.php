...
<div class="stats-grid">
    <div class="card-d stat-card"><div class="card-d-content"><p class="stat-value"><?php echo e($stats['total']); ?></p><p class="stat-label">Total</p></div></div>
    <div class="card-d stat-card"><div class="card-d-content"><p class="stat-value success"><?php echo e($stats['disponibles']); ?></p><p class="stat-label">Disponibles</p></div></div>
    <div class="card-d stat-card"><div class="card-d-content"><p class="stat-value accent"><?php echo e($stats['en_ruta']); ?></p><p class="stat-label">En Ruta</p></div></div>
    <div class="card-d stat-card"><div class="card-d-content"><p class="stat-value warning"><?php echo e($stats['ocupados']); ?></p><p class="stat-label">Ocupados</p></div></div>
    <div class="card-d stat-card"><div class="card-d-content"><p class="stat-value destructive"><?php echo e($stats['fuera_servicio']); ?></p><p class="stat-label">Fuera de Servicio</p></div></div>
</div>
...
<div class="card-d">
    <div class="table-wrapper">
        <table class="table-d">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $domiciliarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td>
                        <div class="driver-info">
                            <div class="driver-avatar"><?php echo e($dom->iniciales); ?></div>
                            <div>
                                <p class="driver-name"><?php echo e($dom->nombre); ?></p>
                                <p class="driver-date">Desde <?php echo e($dom->created_at->format('d/m/Y')); ?></p>
                            </div>
                        </div>
                    </td>
                    <td><?php echo e($dom->telefono); ?></td>
                    <td><?php echo e(ucfirst($dom->vehiculo_tipo)); ?> (<?php echo e($dom->placa ?? 'N/A'); ?>)</td>
                    <td><?php echo e($dom->zona->nombre ?? 'N/A'); ?></td>
                    <td><?php echo e($dom->pedidos_hoy); ?></td>
                    <td>
                        <form action="<?php echo e(route('admin.domiciliarios.update', $dom->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                            <input type="hidden" name="nombre" value="<?php echo e($dom->nombre); ?>">
                            <input type="hidden" name="telefono" value="<?php echo e($dom->telefono); ?>">
                            <input type="hidden" name="vehiculo_tipo" value="<?php echo e($dom->vehiculo_tipo); ?>">
                            <input type="hidden" name="zona_id" value="<?php echo e($dom->zona_id); ?>">
                            <select name="estado" class="select-d" onchange="this.form.submit()" style="padding: 0.4rem 1.5rem 0.4rem 0.7rem; font-size: 0.8rem;">
                                <option value="disponible" <?php echo e($dom->estado == 'disponible' ? 'selected' : ''); ?>>Disponible</option>
                                <option value="en_ruta" <?php echo e($dom->estado == 'en_ruta' ? 'selected' : ''); ?>>En Ruta</option>
                                <option value="ocupado" <?php echo e($dom->estado == 'ocupado' ? 'selected' : ''); ?>>Ocupado</option>
                                <option value="fuera_servicio" <?php echo e($dom->estado == 'fuera_servicio' ? 'selected' : ''); ?>>Fuera de Servicio</option>
                            </select>
                        </form>
                    </td>
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <button class="dropdown-item" onclick="viewDetail(<?php echo e($dom->id); ?>)">Ver detalle</button>
                                <button class="dropdown-item" onclick="openEditForm(<?php echo e($dom->id); ?>)">Editar</button>
                                <form action="<?php echo e(route('admin.domiciliarios.destroy', $dom->id)); ?>" method="POST" onsubmit="return confirm('¿Eliminar?')">
...
<script>
    ...
    function openCreateForm() {
        ...
        document.getElementById('mainForm').action = "<?php echo e(route('admin.domiciliarios.store')); ?>";
...
<?php echo $__env->make('admin.Layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Cafeteria Vs.2 - PWA\cafeteria-web\resources\views/admin/domiciliarios/index.blade.php ENDPATH**/ ?>