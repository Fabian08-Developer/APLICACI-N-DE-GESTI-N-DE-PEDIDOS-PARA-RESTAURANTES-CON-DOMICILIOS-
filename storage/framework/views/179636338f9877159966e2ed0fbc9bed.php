...
<div x-data="salesReport()">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2rem;">
        <div>
            <h1 style="font-family: 'DM Serif Display', serif; font-size: 1.8rem; margin-bottom: 0.2rem; display: flex; align-items: center; gap: 10px;">
                ...
                <?php if($changes['ventasTotales'] >= 0): ?>
                    <span style="font-size: 0.75rem; background: rgba(52, 211, 153, 0.15); color: #34D399; padding: 2px 8px; border-radius: 12px; font-family: 'DM Sans', sans-serif;">
                        ↗ +<?php echo e($changes['ventasTotales']); ?>% vs anterior
                    </span>
                <?php else: ?>
            ...
            <p style="color: var(--text-sec); font-size: 0.85rem;"><?php echo e(\Carbon\Carbon::parse($end)->translatedFormat('l, d \d\e F \d\e Y')); ?></p>
        </div>
    ...
    <div class="shadcn-filters-container" style="margin-bottom: 2rem;">
        <div class="shadcn-filters">
            ...
            <input type="hidden" name="start" form="filterForm" id="filterStart" value="<?php echo e($start); ?>">
            <input type="hidden" name="end" form="filterForm" id="filterEnd" value="<?php echo e($end); ?>">

            <a href="<?php echo e(route('admin.reportes.ventas')); ?>" class="shadcn-btn" style="margin-left: auto; text-decoration: none; color: var(--text-sec); border-color: transparent; background: transparent; box-shadow: none;" onmouseover="this.style.backgroundColor='rgba(255,255,255,0.05)'; this.style.color='var(--text-main)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--text-sec)'">
        ...
        <div x-show="showFilters" x-collapse style="display: none; margin-top: 1rem; position: relative; z-index: 20;">
            <div class="shadcn-card">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    <div>
                        ...
                        <div class="shadcn-checkbox-group">
                            <?php $__currentLoopData = $categoriasFiltro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="shadcn-checkbox-item">
                                    <input type="checkbox" name="categorias[]" value="<?php echo e($cat->id); ?>" class="shadcn-checkbox" form="filterForm" <?php echo e(is_array(request('categorias')) && in_array($cat->id, request('categorias')) ? 'checked' : ''); ?>>
                                    <span class="shadcn-checkbox-label"><?php echo e($cat->nombre); ?></span>
                                </label>
                    ...
                    <div>
                        ...
                        <div class="shadcn-checkbox-group">
                            <?php $__currentLoopData = $metodosPagoFiltro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="shadcn-checkbox-item">
                                    <input type="checkbox" name="metodos_pago[]" value="<?php echo e($metodo); ?>" class="shadcn-checkbox" form="filterForm" <?php echo e(is_array(request('metodos_pago')) && in_array($metodo, request('metodos_pago')) ? 'checked' : ''); ?>>
                                    <span class="shadcn-checkbox-label"><?php echo e(ucfirst(strtolower($metodo))); ?></span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="shadcn-checkbox-group">
                            <?php $__currentLoopData = $productosTopFiltro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="shadcn-checkbox-item">
                                    <input type="checkbox" name="productos_top[]" value="<?php echo e($prod); ?>" class="shadcn-checkbox" form="filterForm" <?php echo e(is_array(request('productos_top')) && in_array($prod, request('productos_top')) ? 'checked' : ''); ?>>
                                    <span class="shadcn-checkbox-label"><?php echo e($prod); ?></span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                ...
                <div style="margin-top: 1.5rem; display: flex; justify-content: flex-end; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 1rem;">
                    <form id="filterForm" action="<?php echo e(route('admin.reportes.ventas')); ?>" method="GET">
    ...
    <div class="grid-tarjetas" style="grid-template-columns: repeat(4, 1fr);">
        ...
        <div class="tarjeta-stat" style="position: relative; padding: 1.2rem;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.8rem;">
                ...
                <?php if($changes['ventasTotales'] >= 0): ?>
                    <span style="font-size: 0.7rem; background: rgba(52, 211, 153, 0.1); color: #34D399; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↗ <?php echo e($changes['ventasTotales']); ?>%</span>
                <?php else: ?>
                    <span style="font-size: 0.7rem; background: rgba(248, 113, 113, 0.1); color: #F87171; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↘ <?php echo e(abs($changes['ventasTotales'])); ?>%</span>
                <?php endif; ?>
            </div>
            <div class="stat-label">Ventas Totales</div>
            <div class="stat-numero" style="font-size: 1.8rem;">$<?php echo e(number_format($currentMetrics['ventasTotales'], 0, ',', '.')); ?></div>
        </div>
        ...
        <div class="tarjeta-stat" style="position: relative; padding: 1.2rem;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.8rem;">
                ...
                <?php if($changes['clientesAtendidos'] >= 0): ?>
                    <span style="font-size: 0.7rem; background: rgba(52, 211, 153, 0.1); color: #34D399; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↗ <?php echo e($changes['clientesAtendidos']); ?>%</span>
                <?php else: ?>
                    <span style="font-size: 0.7rem; background: rgba(248, 113, 113, 0.1); color: #F87171; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↘ <?php echo e(abs($changes['clientesAtendidos'])); ?>%</span>
                <?php endif; ?>
            </div>
            <div class="stat-label">Clientes Atendidos</div>
            <div class="stat-numero" style="font-size: 1.8rem;"><?php echo e(number_format($currentMetrics['clientesAtendidos'], 0, ',', '.')); ?></div>
        </div>
        ...
        <div class="tarjeta-stat" style="position: relative; padding: 1.2rem;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.8rem;">
                ...
                <?php if($changes['ticketPromedio'] >= 0): ?>
                    <span style="font-size: 0.7rem; background: rgba(52, 211, 153, 0.1); color: #34D399; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↗ <?php echo e($changes['ticketPromedio']); ?>%</span>
                <?php else: ?>
                    <span style="font-size: 0.7rem; background: rgba(248, 113, 113, 0.1); color: #F87171; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↘ <?php echo e(abs($changes['ticketPromedio'])); ?>%</span>
                <?php endif; ?>
            </div>
            <div class="stat-label">Ticket Promedio</div>
            <div class="stat-numero" style="font-size: 1.8rem;">$<?php echo e(number_format($currentMetrics['ticketPromedio'], 0, ',', '.')); ?></div>
        </div>
        ...
        <div class="tarjeta-stat" style="position: relative; padding: 1.2rem;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.8rem;">
                ...
                <?php if($changes['totalPedidos'] >= 0): ?>
                    <span style="font-size: 0.7rem; background: rgba(52, 211, 153, 0.1); color: #34D399; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↗ <?php echo e($changes['totalPedidos']); ?>%</span>
                <?php else: ?>
                    <span style="font-size: 0.7rem; background: rgba(248, 113, 113, 0.1); color: #F87171; padding: 2px 6px; border-radius: 4px; font-weight: 600;">↘ <?php echo e(abs($changes['totalPedidos'])); ?>%</span>
                <?php endif; ?>
            </div>
            <div class="stat-label">Total Pedidos</div>
            <div class="stat-numero" style="font-size: 1.8rem;"><?php echo e($currentMetrics['totalPedidos']); ?></div>
        </div>
    </div>
                ...
                <?php $__currentLoopData = $categoriasChart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="margin-bottom: 1rem;">
                        <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 0.4rem;">
                            <span style="color: var(--text-main);"><?php echo e($cat->nombre); ?></span>
                            <div style="display: flex; gap: 15px;">
                                <strong style="color: var(--text-main);">$<?php echo e(number_format($cat->total, 0, ',', '.')); ?></strong>
                                <span style="color: var(--text-sec); font-size: 0.75rem;"><?php echo e($currentMetrics['ventasTotales'] > 0 ? round(($cat->total / $currentMetrics['ventasTotales']) * 100) : 0); ?>%</span>
                            </div>
                        </div>
                        <div class="progreso-vacia" style="height: 6px; background: rgba(255,255,255,0.05);">
                            <div class="progreso-llena" style="width: <?php echo e($currentMetrics['ventasTotales'] > 0 ? ($cat->total / $currentMetrics['ventasTotales']) * 100 : 0); ?>%; background: var(--primary);"></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <div x-show="showExportSidebar"
        ...
        <div class="exp-panel" id="expPanel">
            ...
            <form id="expForm" action="<?php echo e(route('admin.reportes.exportar')); ?>" method="GET" style="display:none;">
...
<script>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('scheduleData', () => ({
            ...
            async fetchSchedules() {
                try {
                    this.activeSchedules = await this.apiRequest('<?php echo e(route("admin.reportes.programacion.index")); ?>');
                } catch (e) {
            ...
            async deleteSchedule(id) {
                ...
                try {
                    await this.apiRequest(`<?php echo e(url('admin/reportes/programacion')); ?>/${id}/eliminar`, 'POST');
            ...
            async sendTestReport() {
                ...
                try {
                    await this.apiRequest('<?php echo e(route("admin.reportes.programacion.test")); ?>', 'POST', {
                        method: this.method,
            ...
            async saveSchedule() {
                ...
                try {
                    ...
                    const response = await this.apiRequest('<?php echo e(route("admin.reportes.programacion.store")); ?>', 'POST', data);
        ...
        Alpine.data('salesReport', () => ({
            ...
            init() {
                ...
                this.fpInstance = flatpickr(this.$refs.dateRangeInput, {
                    ...
                    altInput: true,
                    altFormat: "d M Y",
                    defaultDate: ["<?php echo e($start); ?>", "<?php echo e($end); ?>"],
            ...
            sendAiMessage() {
                ...
                setTimeout(() => {
                    this.isTyping = false;
                    let response = "Analizando tus datos... Las ventas este periodo han sido de $" + <?php echo e($currentMetrics['ventasTotales']); ?> + ". Recomiendo promocionar las categorías con menos movimiento para equilibrar.";
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var optionsTendencia = {
            series: [{
                name: 'Ventas ($)',
                data: <?php echo json_encode($trendTotals, 15, 512) ?>
            }],
            chart: {
                type: 'area',
                height: 280,
            ...
            xaxis: {
                categories: <?php echo json_encode($trendDates, 15, 512) ?>,
        ...
        var optionsCategorias = {
            series: <?php echo json_encode($catTotals->map(fn($v) => (int)$v), 15, 512) ?>,
            labels: <?php echo json_encode($catNames, 15, 512) ?>,
            chart: {
                type: 'donut',
                height: 280,
                background: 'transparent',
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leide\OneDrive\Documentos\GitHub\APLICACION-DE-GESTION-DE-PEDIDOS-PARA-RESTAURANTES-CON-DOMICILIOS\resources\views/admin/reports/sales.blade.php ENDPATH**/ ?>