...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.domiciliarios.index')); ?>" class="nav-item <?php echo e(request()->is('admin/domiciliarios*') ? 'activo' : ''); ?>" onclick="toggleSidebar()">
            ...
            <a href="<?php echo e(route('admin.zonas.index')); ?>" class="nav-item <?php echo e(request()->is('admin/zonas*') ? 'activo' : ''); ?>" onclick="toggleSidebar()">
            ...
            <a href="<?php echo e(route('admin.reportes.ventas')); ?>" class="nav-item <?php echo e(request()->is('admin/reportes*') ? 'activo' : ''); ?>" onclick="toggleSidebar()">
...
</html><?php /**PATH C:\Users\leide\OneDrive\Documentos\GitHub\APLICACION-DE-GESTION-DE-PEDIDOS-PARA-RESTAURANTES-CON-DOMICILIOS\resources\views/admin/layout.blade.php ENDPATH**/ ?>